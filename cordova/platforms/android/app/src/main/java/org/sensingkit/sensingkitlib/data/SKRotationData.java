...
public class SKRotationData extends SKAbstractData {
     ...
     */
    public SKRotationData(final long timestamp, final long timestampSensor, final float x, final float y, final float z, final float cos, final float headingAccuracy) {
     ...
     *                  where theta is the angle of rotation
     */
    public SKRotationData(final long timestamp, final long timestampSensor, final float x, final float y, final float z) {
        this(timestamp, timestampSensor, x, y, z, 0, 0);
    }
    ...
    public static String csvHeader() {
        return "timeIntervalSince1970,timestampSensor,x,y,z,cos,headingAccuracy";
    }
    ...
    public String getDataInCSV() {
        return String.format(Locale.US, "%d,%d,%f,%f,%f,%f,%f", this.timestamp, this.timestampSensor, this.x, this.y, this.z, this.cos, this.headingAccuracy);
    }
