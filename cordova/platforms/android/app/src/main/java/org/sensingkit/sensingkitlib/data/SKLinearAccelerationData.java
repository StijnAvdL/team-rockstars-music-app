...
public class SKLinearAccelerationData extends SKAbstractData {
     ...
     */
    public SKLinearAccelerationData(final long timestamp, final long timestampSensor, final float x, final float y, final float z) {
    ...
    public static String csvHeader() {
        return "timeIntervalSince1970,timestampSensor,x,y,z";
    }
    ...
    public String getDataInCSV() {
        return String.format(Locale.US, "%d,%d,%f,%f,%f", this.timestamp, this.timestampSensor, this.x, this.y, this.z);
    }
